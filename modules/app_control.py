...
class SystemTasks:
	...
	def openApp(self, appName):
		...
		appName = appName.replace('record', 'psr')
		appName = appName.replace('charactor', 'charmap')
		appName = appName.replace('cleanup', 'cleanmgr')
		appName = appName.replace('command', 'cmd')
		appName = appName.replace('magnifier', 'magnify')
		appName = appName.replace('narrator', 'narrator')
		appName = appName.replace('notepad', 'notepad')
